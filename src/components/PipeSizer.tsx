...
>
  <div className={`mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 h-[60px] sm:h-[68px] flex items-center justify-between ${dark ? "bg-[#050816]/70" : "bg-white/70"}`}>
    ...
    <div className="w-11" />
      ...
      <main className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 pt-4 pb-24">
        {tab === "mcquay" ? (
                ...
                <div className="bg-[#f7b500] px-5 py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-black font-bold text-[15px] leading-tight">ASHRAE STANDARD PIPE CHART</h3>

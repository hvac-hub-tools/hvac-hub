/**
 * All Catalogue — product card
 *
 * Drop this file into: src/components/AllCatalogueCard.tsx
 */
...
export default function AllCatalogueCard({
  ...
  return (
    <button
      onClick={onSelect}
      className="group flex w-full cursor-pointer flex-col overflow-hidden rounded-2xl text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
    ...
    >
      ...
      >
        <span className="text-[11px] font-medium" style={{ color: p.textMuted }}>
